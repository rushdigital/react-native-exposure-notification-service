...
const exposure_notification_module_1 = __importStar(
  require('./exposure-notification-module')
);
const permissions_1 = require('./utils/permissions');
const types_1 = require('./types');
const emitter = new react_native_1.NativeEventEmitter(
  exposure_notification_module_1.default
);
const initialState = {
  status: {
...
exports.ExposureContext = react_1.createContext(
...
exports.ExposureProvider = ({
  children,
  isReady = false,
  traceConfiguration,
  serverUrl,
  keyServerUrl,
  keyServerType = exposure_notification_module_1.KeyServerType.nearform,
  authToken = '',
  refreshToken = '',
  notificationTitle,
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        if (
          ...
          if (
            !(
              latestStatus &&
              (((_a = latestStatus.type) === null || _a === void 0
                ? void 0
                : _a.indexOf(
                    exposure_notification_module_1.StatusType.paused
                  )) > -1 ||
                ((_b = latestStatus.type) === null || _b === void 0
                  ? void 0
                  : _b.indexOf(
                      exposure_notification_module_1.StatusType.stopped
                    )) > -1)
            )
          ) {
            start();
  ...
  const validateStatus = (status) =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _a;
      let newStatus =
        status || (yield exposure_notification_module_1.default.status());
      const enabled = yield exposure_notification_module_1.default.exposureEnabled();
      const isAuthorised = yield exposure_notification_module_1.default.isAuthorised();
      const canSupport = yield exposure_notification_module_1.default.canSupport();
      const isStarting =
        (isAuthorised ===
          exposure_notification_module_1.AuthorisedStatus.unknown ||
          isAuthorised ===
            exposure_notification_module_1.AuthorisedStatus.granted) &&
        newStatus.state ===
          exposure_notification_module_1.StatusState.unavailable &&
        ((_a = newStatus.type) === null || _a === void 0
          ? void 0
          : _a.includes(exposure_notification_module_1.StatusType.starting));
  ...
  const simulateExposure = (timeDelay, exposureDays) => {
    exposure_notification_module_1.default.simulateExposure(
      timeDelay,
      exposureDays
    );
  };
  ...
  const readPermissions = react_1.useCallback(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        setState((s) =>
          Object.assign(Object.assign({}, s), {permissions: perms})
        );
      }),
    []
  );
  const askPermissions = react_1.useCallback(
    () =>
      __awaiter(void 0, void 0, void 0, function* () {
  ...
  const value = Object.assign(Object.assign({}, state), {
    start,
    stop,
    pause,
    configure,
  ...
  return react_1.default.createElement(
    exports.ExposureContext.Provider,
    {value: value},
    children
  );
};
