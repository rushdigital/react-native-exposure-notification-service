...
exports.ExposureProvider = ({ children, isReady = false, traceConfiguration, serverUrl, keyServerUrl, keyServerType = exposure_notification_module_1.KeyServerType.nearform, authToken = '', refreshToken = '', notificationTitle, notificationDescription, callbackNumber = '', analyticsOptin = false, notificationRepeat = 0, certList = '' }) => {
    ...
    const configure = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const iosLimit = traceConfiguration.fileLimitiOS > 0
            ...
            const config = {
                ...
                fileLimit: react_native_1.Platform.OS === 'ios' ? iosLimit : traceConfiguration.fileLimit,
                notificationTitle,
    ...
    const checkExposure = (readDetails, skipTimeCheck) => {
        exposure_notification_module_1.default.checkExposure(readDetails, skipTimeCheck);
    };
    const simulateExposure = (timeDelay) => {
        exposure_notification_module_1.default.simulateExposure(timeDelay);
    };
